<?php
$projectUrl = get_post_meta($post->ID, 'working_url', true);
...
$projectFeature = get_post_meta($post->ID, 'working_video', true);
$projectCategory = get_post_meta($post->ID, 'working_category', true);
$projectTagline = get_post_meta($post->ID, 'working_tagline', true);
