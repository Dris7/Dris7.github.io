...
{
	if (!function_exists('run_mp_core'))
		echo '<div class="error"><p>' . __('Warning: The theme needs My Portfolio Core to function', 'my-portfolio') . '</p></div>';
}
...
function my_portfolio_scripts()
{
	...
	wp_enqueue_style(
		...
		array(),
		filemtime(get_stylesheet_directory() . '/assets/bootstrap.min.css'),
		false
	);
	wp_enqueue_script(
		'bootstrap-js',
		get_stylesheet_directory_uri() . '/assets/bootstrap.bundle.min.js',
		array(),
		filemtime(get_stylesheet_directory() . '/assets/bootstrap.bundle.min.js'),
		true
	);
	wp_enqueue_style(
		'custom-styles',
	...
	// FONTS
	wp_enqueue_style('font-awesome', 'https://use.fontawesome.com/releases/v5.15.4/css/all.css', array(), '5.15.4', 'all');
	wp_enqueue_style('font-awesome-regular', 'https://use.fontawesome.com/releases/v5.15.4/css/regular.css', array(), '5.15.4', 'all');
